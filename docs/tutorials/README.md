...
本目录是默认分支持续修订的**权威教程**。课程号表示学习顺序，包版本表示发布版本，Git tag 表示代码快照；例如第 19 课的基础实现是包 `0.19.0`、tag `v0.19`，审阅修复是包 `0.19.1`、tag `v0.19.1`。每课开头会声明自己的 tag 和相邻 diff 基线。
...
1. **完整路线**：从[阶段一](../../README.md#stage-1)开始，依次读到[阶段六](../../README.md#stage-6)。
