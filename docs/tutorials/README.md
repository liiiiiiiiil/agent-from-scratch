...
当前最新课程是[第 47 课：具名子代理角色](47-agent-profiles.md)，属于阶段十三。它在同步只读委派上加入冻结角色、模型与工具交集，以及由父侧预授权的 Skill；后台子代理和子会话续接仍未实现。
...
1. **完整路线**：从[阶段一](../../README.md#stage-1)开始，依次读到[阶段十三](../../README.md#stage-13)的第 47 课。
