...
本目录是默认分支持续修订的**权威教程**。课程号表示学习顺序，包版本表示发布版本，Git tag 表示代码快照；第 27 课对应后台进程观察。每课开头会声明自己的 tag 和相邻 diff 基线。

当前最新课程是[第 27 课：观察后台进程](27-process-observation.md)，属于阶段八。它解释如何跨轮次取得新增日志与最终退出码，以及长时间没有新消息时怎样交回 CLI。
...
1. **完整路线**：从[阶段一](../../README.md#stage-1)开始，依次读到[阶段八](../../README.md#stage-8)的第 27 课。
