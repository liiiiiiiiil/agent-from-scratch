...
- [`project-task-orchestration-plan.md`](project-task-orchestration-plan.md) — 阶段五项目感知与任务编排实施计划（v0.14 Project Instructions / v0.15 Todo Task State / v0.16 Plan-driven Execution）。
- [`reliable-execution-plan.md`](reliable-execution-plan.md) — 阶段六可靠执行实施计划（v0.17 Failure Model / v0.18 Recovery Policy / v0.19 Checkpoint & Rollback / v0.20 Repair Loop）。
