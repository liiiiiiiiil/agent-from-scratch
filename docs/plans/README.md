...
- [`mcp-skills-plan.md`](mcp-skills-plan.md) — 阶段十二 MCP 与 Skills 实施计划；v0.43 最小 stdio MCP Client 已实现，v0.44–v0.46 仍规划 MCP Tool 接入 Runtime、本地按需 Skills，以及受限远程 HTTP / 文本 Resource / 文本 Prompt。
