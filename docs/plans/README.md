...
- [`subagent-delegation-plan.md`](subagent-delegation-plan.md) — 阶段十受控子代理委派实施计划；v0.34 最小同步只读委派、v0.35 共享父子运行循环和 v0.36 多 provider/统一协议适配已实现，v0.37 生命周期与聚合预算、v0.38 有界并行、v0.39 持久委派待实施。保持子代理只读、单层，由父 Agent 独占修改和完成判定。
