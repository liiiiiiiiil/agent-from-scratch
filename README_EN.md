...
**Current status**: code and tutorials reach `v0.24` (lesson 24: evidence-backed replanning and bounded stagnation). The authoritative tutorials are the current files under `docs/tutorials/`; check out the lesson's declared tag only when running its code.
...
<table width="100%">
  ...
  <tbody>
    ...
    <tr><td>Later versions</td><td>Added as needed</td><td>Continue expanding plan replay, memory, sandboxing, and related capabilities.</td></tr>
  </tbody>
</table>
