...
> **Current status**: The code and tutorials are up to `v0.19.1` (single-file Checkpoint / Rollback review fixes; see lesson 19).
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>v0.19 / v0.19.1</strong></td><td><a href="./docs/tutorials/19-checkpoint-rollback.md">Checkpoint / Rollback</a></td><td>Atomically restore one file from a private before-image with conflict detection; v0.19.1 includes review fixes.</td></tr>
