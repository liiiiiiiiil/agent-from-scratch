...
> **当前状态**：最新代码和教程已到 `v0.18`（Recovery Policy）。
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>v0.18</strong></td><td><a href="./docs/tutorials/18-recovery-policy.md">Recovery Policy</a></td><td>用受限动作恢复失败并隔离 generation。</td></tr>
