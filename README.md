...
**当前状态**：主线代码和教程已完成 `v0.46`（第 46 课：受限 HTTP MCP、文本 Resource 与 Prompt），阶段十二已完成本地/回环 HTTP MCP、父侧 MCP Tool、文本 Resource、文本 Prompt 与本地 Skills。教程以默认分支的 `docs/tutorials/` 为准；运行某课时再切换该课声明的代码 tag。
